...
<head>
    ...
    <title>Gagal - KadKahwin Digital</title>
    ...
    <style>
        ...
        .fail-card h1 { font-family: var(--font-display); font-size: 24px; margin-bottom: 12px; }
...
<body>
    <div class="fail-page">
        <div class="fail-card">
            ...
            <a href="index.php#create" class="btn btn-primary btn-large">Cuba Lagi</a>
        </div>
    </div>
</body>
</html>
