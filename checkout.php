...
$amount = floatval($_POST['amount'] ?? 25);
$cardData = $_POST['card_data'] ?? '';
$_SESSION['card_data'] = $cardData;
$_SESSION['amount'] = $amount;
$_SESSION['order_id'] = 'KKD-' . time() . '-' . rand(1000, 9999);
?>
<!DOCTYPE html>
<html lang="ms">
<head>
    ...
    <title>Checkout - KadKahwin Digital</title>
    ...
    <style>
        ...
        .checkout-header h1 { font-family: var(--font-display); font-size: 24px; margin-bottom: 8px; }
    ...
    <div class="checkout-page">
        <div class="checkout-card">
            ...
            <div class="order-summary">
                <div class="order-row"><span>Kad Kahwin Digital Premium</span><span>1x</span></div>
                <div class="order-row"><span>RSVP Online</span><span>✓</span></div>
                <div class="order-row"><span>Peta Lokasi</span><span>✓</span></div>
                <div class="order-row"><span>Aktif 1 Tahun</span><span>✓</span></div>
